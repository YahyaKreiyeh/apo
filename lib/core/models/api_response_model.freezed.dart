...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ApiResponseModel<T>);
}
...
/// @nodoc
class $ApiResponseModelCopyWith<T,$Res>  {
$ApiResponseModelCopyWith(ApiResponseModel<T> _, $Res Function(ApiResponseModel<T>) __);
}
...
class Success<T> implements ApiResponseModel<T> {
...
@override
String toString() {
  return 'ApiResponseModel<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ApiResponseModelCopyWith<T, $Res> {
...
class Failure<T> implements ApiResponseModel<T> {
...
@override
String toString() {
  return 'ApiResponseModel<$T>.failure(apiErrorModel: $apiErrorModel)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $ApiResponseModelCopyWith<T, $Res> {
