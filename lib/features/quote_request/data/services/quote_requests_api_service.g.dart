...
part of 'quote_requests_api_service.dart';
...
class _QuoteRequestsApiService implements QuoteRequestsApiService {
  _QuoteRequestsApiService(this._dio, {this.baseUrl, this.errorLogger}) {
